...
module rv_plic_reg_top (
  ...
  always_comb begin
    ...
    addr_hit[111] = (reg_addr == RV_PLIC_IE0_0_OFFSET);
    addr_hit[112] = (reg_addr == RV_PLIC_IE0_1_OFFSET);
    addr_hit[113] = (reg_addr == RV_PLIC_IE0_2_OFFSET);
    addr_hit[114] = (reg_addr == RV_PLIC_IE0_3_OFFSET);
    addr_hit[115] = (reg_addr == RV_PLIC_THRESHOLD0_OFFSET);
    addr_hit[116] = (reg_addr == RV_PLIC_CC0_OFFSET);
    addr_hit[117] = (reg_addr == RV_PLIC_MSIP0_OFFSET);
  end
  ...
  assign ie0_0_e_0_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_0_wd = reg_wdata[0];

  assign ie0_0_e_1_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_1_wd = reg_wdata[1];

  assign ie0_0_e_2_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_2_wd = reg_wdata[2];

  assign ie0_0_e_3_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_3_wd = reg_wdata[3];

  assign ie0_0_e_4_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_4_wd = reg_wdata[4];

  assign ie0_0_e_5_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_5_wd = reg_wdata[5];

  assign ie0_0_e_6_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_6_wd = reg_wdata[6];

  assign ie0_0_e_7_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_7_wd = reg_wdata[7];

  assign ie0_0_e_8_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_8_wd = reg_wdata[8];

  assign ie0_0_e_9_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_9_wd = reg_wdata[9];

  assign ie0_0_e_10_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_10_wd = reg_wdata[10];

  assign ie0_0_e_11_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_11_wd = reg_wdata[11];

  assign ie0_0_e_12_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_12_wd = reg_wdata[12];

  assign ie0_0_e_13_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_13_wd = reg_wdata[13];

  assign ie0_0_e_14_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_14_wd = reg_wdata[14];

  assign ie0_0_e_15_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_15_wd = reg_wdata[15];

  assign ie0_0_e_16_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_16_wd = reg_wdata[16];

  assign ie0_0_e_17_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_17_wd = reg_wdata[17];

  assign ie0_0_e_18_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_18_wd = reg_wdata[18];

  assign ie0_0_e_19_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_19_wd = reg_wdata[19];

  assign ie0_0_e_20_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_20_wd = reg_wdata[20];

  assign ie0_0_e_21_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_21_wd = reg_wdata[21];

  assign ie0_0_e_22_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_22_wd = reg_wdata[22];

  assign ie0_0_e_23_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_23_wd = reg_wdata[23];

  assign ie0_0_e_24_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_24_wd = reg_wdata[24];

  assign ie0_0_e_25_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_25_wd = reg_wdata[25];

  assign ie0_0_e_26_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_26_wd = reg_wdata[26];

  assign ie0_0_e_27_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_27_wd = reg_wdata[27];

  assign ie0_0_e_28_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_28_wd = reg_wdata[28];

  assign ie0_0_e_29_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_29_wd = reg_wdata[29];

  assign ie0_0_e_30_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_30_wd = reg_wdata[30];

  assign ie0_0_e_31_we = addr_hit[111] & reg_we & ~wr_err;
  assign ie0_0_e_31_wd = reg_wdata[31];

  assign ie0_1_e_32_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_32_wd = reg_wdata[0];

  assign ie0_1_e_33_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_33_wd = reg_wdata[1];

  assign ie0_1_e_34_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_34_wd = reg_wdata[2];

  assign ie0_1_e_35_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_35_wd = reg_wdata[3];

  assign ie0_1_e_36_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_36_wd = reg_wdata[4];

  assign ie0_1_e_37_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_37_wd = reg_wdata[5];

  assign ie0_1_e_38_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_38_wd = reg_wdata[6];

  assign ie0_1_e_39_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_39_wd = reg_wdata[7];

  assign ie0_1_e_40_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_40_wd = reg_wdata[8];

  assign ie0_1_e_41_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_41_wd = reg_wdata[9];

  assign ie0_1_e_42_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_42_wd = reg_wdata[10];

  assign ie0_1_e_43_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_43_wd = reg_wdata[11];

  assign ie0_1_e_44_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_44_wd = reg_wdata[12];

  assign ie0_1_e_45_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_45_wd = reg_wdata[13];

  assign ie0_1_e_46_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_46_wd = reg_wdata[14];

  assign ie0_1_e_47_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_47_wd = reg_wdata[15];

  assign ie0_1_e_48_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_48_wd = reg_wdata[16];

  assign ie0_1_e_49_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_49_wd = reg_wdata[17];

  assign ie0_1_e_50_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_50_wd = reg_wdata[18];

  assign ie0_1_e_51_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_51_wd = reg_wdata[19];

  assign ie0_1_e_52_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_52_wd = reg_wdata[20];

  assign ie0_1_e_53_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_53_wd = reg_wdata[21];

  assign ie0_1_e_54_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_54_wd = reg_wdata[22];

  assign ie0_1_e_55_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_55_wd = reg_wdata[23];

  assign ie0_1_e_56_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_56_wd = reg_wdata[24];

  assign ie0_1_e_57_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_57_wd = reg_wdata[25];

  assign ie0_1_e_58_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_58_wd = reg_wdata[26];

  assign ie0_1_e_59_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_59_wd = reg_wdata[27];

  assign ie0_1_e_60_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_60_wd = reg_wdata[28];

  assign ie0_1_e_61_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_61_wd = reg_wdata[29];

  assign ie0_1_e_62_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_62_wd = reg_wdata[30];

  assign ie0_1_e_63_we = addr_hit[112] & reg_we & ~wr_err;
  assign ie0_1_e_63_wd = reg_wdata[31];

  assign ie0_2_e_64_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_64_wd = reg_wdata[0];

  assign ie0_2_e_65_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_65_wd = reg_wdata[1];

  assign ie0_2_e_66_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_66_wd = reg_wdata[2];

  assign ie0_2_e_67_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_67_wd = reg_wdata[3];

  assign ie0_2_e_68_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_68_wd = reg_wdata[4];

  assign ie0_2_e_69_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_69_wd = reg_wdata[5];

  assign ie0_2_e_70_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_70_wd = reg_wdata[6];

  assign ie0_2_e_71_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_71_wd = reg_wdata[7];

  assign ie0_2_e_72_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_72_wd = reg_wdata[8];

  assign ie0_2_e_73_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_73_wd = reg_wdata[9];

  assign ie0_2_e_74_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_74_wd = reg_wdata[10];

  assign ie0_2_e_75_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_75_wd = reg_wdata[11];

  assign ie0_2_e_76_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_76_wd = reg_wdata[12];

  assign ie0_2_e_77_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_77_wd = reg_wdata[13];

  assign ie0_2_e_78_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_78_wd = reg_wdata[14];

  assign ie0_2_e_79_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_79_wd = reg_wdata[15];

  assign ie0_2_e_80_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_80_wd = reg_wdata[16];

  assign ie0_2_e_81_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_81_wd = reg_wdata[17];

  assign ie0_2_e_82_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_82_wd = reg_wdata[18];

  assign ie0_2_e_83_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_83_wd = reg_wdata[19];

  assign ie0_2_e_84_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_84_wd = reg_wdata[20];

  assign ie0_2_e_85_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_85_wd = reg_wdata[21];

  assign ie0_2_e_86_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_86_wd = reg_wdata[22];

  assign ie0_2_e_87_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_87_wd = reg_wdata[23];

  assign ie0_2_e_88_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_88_wd = reg_wdata[24];

  assign ie0_2_e_89_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_89_wd = reg_wdata[25];

  assign ie0_2_e_90_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_90_wd = reg_wdata[26];

  assign ie0_2_e_91_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_91_wd = reg_wdata[27];

  assign ie0_2_e_92_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_92_wd = reg_wdata[28];

  assign ie0_2_e_93_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_93_wd = reg_wdata[29];

  assign ie0_2_e_94_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_94_wd = reg_wdata[30];

  assign ie0_2_e_95_we = addr_hit[113] & reg_we & ~wr_err;
  assign ie0_2_e_95_wd = reg_wdata[31];

  assign ie0_3_e_96_we = addr_hit[114] & reg_we & ~wr_err;
  assign ie0_3_e_96_wd = reg_wdata[0];

  assign ie0_3_e_97_we = addr_hit[114] & reg_we & ~wr_err;
  assign ie0_3_e_97_wd = reg_wdata[1];

  assign ie0_3_e_98_we = addr_hit[114] & reg_we & ~wr_err;
  assign ie0_3_e_98_wd = reg_wdata[2];

  assign ie0_3_e_99_we = addr_hit[114] & reg_we & ~wr_err;
  assign ie0_3_e_99_wd = reg_wdata[3];

  assign ie0_3_e_100_we = addr_hit[114] & reg_we & ~wr_err;
  assign ie0_3_e_100_wd = reg_wdata[4];

  assign ie0_3_e_101_we = addr_hit[114] & reg_we & ~wr_err;
  assign ie0_3_e_101_wd = reg_wdata[5];

  assign ie0_3_e_102_we = addr_hit[114] & reg_we & ~wr_err;
  assign ie0_3_e_102_wd = reg_wdata[6];

  assign threshold0_we = addr_hit[115] & reg_we & ~wr_err;
  assign threshold0_wd = reg_wdata[1:0];

  assign cc0_we = addr_hit[116] & reg_we & ~wr_err;
  assign cc0_wd = reg_wdata[6:0];
  assign cc0_re = addr_hit[116] && reg_re;

  assign msip0_we = addr_hit[117] & reg_we & ~wr_err;
